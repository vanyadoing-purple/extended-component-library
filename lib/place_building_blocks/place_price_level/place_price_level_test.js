...
describe('PlacePriceLevel', () => {
    ...
    it('renders all price levels with a Place', async () => {
      ...
      <gmpx-place-price-level .place=${makeFakePlace({ id: '', priceLevel: 'FREE' })}>
      </gmpx-place-price-level>
      <gmpx-place-price-level .place=${makeFakePlace({ id: '', priceLevel: 'INEXPENSIVE' })}>
      </gmpx-place-price-level>
      <gmpx-place-price-level .place=${makeFakePlace({ id: '', priceLevel: 'MODERATE' })}>
      </gmpx-place-price-level>
      <gmpx-place-price-level .place=${makeFakePlace({ id: '', priceLevel: 'EXPENSIVE' })}>
      </gmpx-place-price-level>
      <gmpx-place-price-level .place=${makeFakePlace({ id: '', priceLevel: 'VERY_EXPENSIVE' })}>
      </gmpx-place-price-level>
    `);
        // clang-format on
...
//# sourceMappingURL=place_price_level_test.js.map