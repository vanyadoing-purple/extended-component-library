    ...
    describe('setting the viewport', () => {
        it('fits the bounds of a registered component', async () => {
            ...
            expect(map.innerMap.fitBounds)
                .toHaveBeenCalledOnceWith(new FakeLatLngBounds({ north: 1, south: 0, east: 1, west: 0 }));
        });
        it('fits the bounds union of two registered components', async () => {
            ...
            expect(map.innerMap.fitBounds)
                .toHaveBeenCalledOnceWith(new FakeLatLngBounds({ north: 2, south: 0, east: 2, west: 0 }));
        });
        it('fits the remaining bounds when unregistering a component', async () => {
            ...
            expect(map.innerMap.fitBounds)
                .toHaveBeenCalledOnceWith(new FakeLatLngBounds({ north: 2, south: 1, east: 2, west: 1 }));
        });
...
//# sourceMappingURL=viewport_manager_test.js.map