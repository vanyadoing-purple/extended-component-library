...
describe('createLinkElementForWebFont', () => {
    it('returns <link> with URI-encoded Google Fonts href', () => {
        ...
        expect(linkEl.href)
            .toBe('https://fonts.googleapis.com/css2?family=Google%20Sans' +
            ':wght@400%3B500');
...
describe('extractTextAndURL', () => {
    it('returns text and URL from valid HTML attribution with link', () => {
        const output = extractTextAndURL('<a href="https://www.google.com/maps/contrib/123">Author Name</a>');
...
//# sourceMappingURL=dom_utils_test.js.map