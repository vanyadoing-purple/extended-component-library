...
], TestComponent.prototype, "shadowButton", void 0);
...
describe('getDeepActiveElement', () => {
    ...
    `);
        const testEl = root.querySelector('gmpx-test-component');
    ...
    `);
        const testEl = root.querySelector('gmpx-test-component');
        await env.waitForStability();
        const slottedButton = testEl.querySelector('button.slotted');
        slottedButton.focus();
...
//# sourceMappingURL=deep_element_access_test.js.map