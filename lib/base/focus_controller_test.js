...
let TestFocusControllerHost = class TestFocusControllerHost extends LitElement {
    constructor() {
        super(...arguments);
        this.callbackSpy = jasmine.createSpy('callback');
        this.focusController = new FocusController(this, this.callbackSpy);
    }
};
TestFocusControllerHost = __decorate([
    customElement('gmpx-test-focus-controller-host')
], TestFocusControllerHost);
describe('FocusController', () => {
    ...
    `);
        ...
        return root.querySelector('gmpx-test-focus-controller-host');
    }
...
//# sourceMappingURL=focus_controller_test.js.map