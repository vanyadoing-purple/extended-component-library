...
describe('IconButton', () => {
    ...
    async function prepareState(buttonHTML) {
        const root = env.render(buttonHTML);
        await env.waitForStability();
        return root.querySelector('gmpx-icon-button');
    }
    it('is defined', () => {
    ...
    it('logs error and resets when variant is set to invalid value', async () => {
        ...
        expect(consoleErrorSpy)
            .toHaveBeenCalledWith('<gmpx-icon-button>: ' +
...
//# sourceMappingURL=icon_button_test.js.map