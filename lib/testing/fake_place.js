 ...
 */
export function makeFakePlace(fields) {
    return {
 ...
 */
export function makeFakePhoto(fields, uri) {
 ...
 */
export function makeFakePlacePhoto(fields, uri) {
...
export const SAMPLE_FAKE_PLACE_RESULT = {
    address_components: [
...
//# sourceMappingURL=fake_place.js.map